...
**Latest Version:** v0.6.0-alpha.1 ([Install](https://github.com/ptgoetz/go-versionbump?tab=readme-ov-file#installation))
...
[here](https://github.com/ptgoetz/go-versionbump/releases/tag/v0.6.0-alpha.1).
